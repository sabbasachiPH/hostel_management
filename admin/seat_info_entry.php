...
if (isset($_POST['save_seat'])) {
    ...
    $sql = "INSERT INTO seat_information(hall_id,floor_id,room_id,seat_no) 
            VALUES ('$hall_id','$floor_id','$room_id','$seat_no')";
                            ...
                            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8" align="center">
                                        <input type="submit" name="save_seat" class="btn btn-info">
                                    </div>
                                </div>
