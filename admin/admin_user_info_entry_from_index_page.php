...
if (isset($_POST['save_admin_user'])) {
    ...
    if ($result_email->num_rows > 0) {
        ...
        if ($result == 1) {
            $_SESSION['message-success'] = "Registration successfull. Now Login to Continue";
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <form class="form-horizontal style-form" action="admin_reg_info_entry.php" method="post" name="registration" onSubmit="return valid();">
