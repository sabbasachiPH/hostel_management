                        ...
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="registration" onSubmit="return valid();">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="regNo" readonly="readonly" value="<?php echo $regNo; ?>" class="form-control" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="subject_id" id="subject_id" disabled style="height:30px; width:525px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="firstName" readonly="readonly" value="<?php echo $firstName; ?>" class="form-control" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="middleName" readonly="readonly" value="<?php echo $middleName; ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="lastName" readonly="readonly" value="<?php echo $lastName; ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="gender" class="form-control" disabled required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="contactNo" readonly="readonly" value="<?php echo $contactNo; ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="address" readonly="readonly" value="<?php echo $address; ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="email" name="email" id="email" readonly="readonly" value="<?php echo $email; ?>" class="form-control" onBlur="checkAvailability()" required="required">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8" align="center">
                                        <a href="student_reg_info_listview.php" class="btn btn-primary">Go to List View</a>
                                    </div>
                                </div>
